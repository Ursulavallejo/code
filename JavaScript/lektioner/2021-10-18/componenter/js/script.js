...
// Event Listener
document.getElementById('event-listener-1').addEventListener('click',function (){
    console.log('Event listener 1 clicked')
})

function eventListenerTwo (text){
    console.log('Event listener 2 clicked')
}
document.getElementById('event-listener-2').addEventListener("click", eventListenerTwo)
